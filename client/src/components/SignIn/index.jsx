...
const SignIn = ({handleLogin}) =>{
    ...
    <Box sx={{margin:'25rem auto',width:500,height:280,p: 2, border: '1px solid grey', borderRadius:"0.5rem" }}>
        <FormControl sx={{padding:"1rem"}}fullWidth>
            ...
            <Button onClick={()=>handleLogin(emailRef.current.value,passRef.current.value)}size="large" sx={{ fontSize: 15, marginTop:"1rem" }} variant="contained" type="Submit">Sign In</Button>
            <a style={{fontSize:16,textAlign:"center",textDecoration:"none"}}href="/signup">Don't have an account yet? Sign Up</a>
        </FormControl>
    </Box>
    </Container>
}
